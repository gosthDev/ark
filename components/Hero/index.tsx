        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              Turn dreams into digital success
                <span className="inline-block relative before:absolute before:bottom-2.5 before:left-0 before:w-full before:h-3 before:bg-titlebg dark:before:bg-titlebgdark before:-z-1 ml-2.5 ">Stories
                </span>
              </h1>
              <p>Welcome to Ark Platforms, Inc, where innovation and creativity come together to boost your digital projects. We are more than developers: we are architects of digital solutions that make your ideas come to life.
              </p>

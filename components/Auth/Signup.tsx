...
import { getAuth, createUserWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, GithubAuthProvider, updateProfile } from "firebase/auth";
...
createUserWithEmailAndPassword(auth, email, password)
  .then(async (userCredential) => {
    ...
    await setDoc(doc(db, "Web-USERS", `${user.email}`), {
      name: name + " " + lastname,
      email: user.email,
      password: password
    });
          ...
          >
            ...
            <form>
              ...
              <div className="flex flex-wrap md:justify-between gap-10 xl:gap-15">
                ...
                <button onClick={signup} aria-label="signup with email and password" className="inline-flex items-center gap-2.5 bg-black dark:bg-btndark hover:bg-blackho ease-in-out duration-300 font-medium text-white rounded-full px-6 py-3">
                  Create Account
                  <svg

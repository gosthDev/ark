          ...
          >
            ...
            <form>
              ...
              <div className="flex flex-wrap items-center md:justify-between gap-10 xl:gap-15">
                ...
                <button onClick={login} aria-label="login with email and password" className="inline-flex items-center gap-2.5 bg-black dark:bg-btndark hover:bg-blackho ease-in-out duration-300 font-medium text-white rounded-full px-6 py-3">
                  Log in
                  <svg

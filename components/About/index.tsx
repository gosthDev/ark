        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              The complete solution for all types of 
              ...
              <p>
              DataWare, a real-time management software that allows you to manage clients, payments and much more, prior launch in
              </p>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>At Ark Platform, we prioritize simplicity, making it incredibly easy for you to access and utilize our comprehensive suite of services.</p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                <div className="w-15 h-15 rounded-[50%] border border-stroke dark:border-strokedark dark:bg-blacksection flex items-center justify-center">
                ...
                <div className="w-3/4">
                  ...
                  <p>Thanks to our dedicated team, we offer our services in multiple languages, allowing you to choose the one that suits you best.</p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                <div className="w-15 h-15 rounded-[50%] border border-stroke dark:border-strokedark dark:bg-blacksection flex items-center justify-center">
                ...
                <div className="w-3/4">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                  Wide Range Of Additional Tools.
                  </h5>
                  <p>DataWare offers a range of powerful tools, including real-time SMS sending to anywhere in the world, and much more.</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
              Everything you need to efficiently manage your company in a single software solution.
              </p>
              <div>
                <a
                  href="https://dataware.arkcorporation.es/"
